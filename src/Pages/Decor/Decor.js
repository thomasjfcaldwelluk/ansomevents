	...
	return (
		<PageWrapper id='Ansom_Events_Decor' aria-label='Main Decor'>
			<SEO
				...
				description='Elevate your event with Ansom Events Decor. From elegant backdrops to vibrant balloon arrangements, we create unforgettable atmospheres for weddings, corporate events,'
